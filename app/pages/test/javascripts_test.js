...
const API_KEY = process.env.AZURE_AI_API_KEY_CHATGPT35;
const AZURE_AI_SERVER_URL = process.env.AZURE_AI_SERVER_URL;
...
// ページコンポーネント
export default function HelloAzureAI({ context }) {
  return (
    <div>
      <h1>TestJson!!</h1>
